#  BitPesa Client Library for PHP

This is the PHP client library for use with the BitPesa API.
To use the API please register and obtain valid API keys on the [BitPesa developer portal](https://developers.bitpesa.co/).
...
```php
require_once('/path/to/BitPesaSdk/vendor/autoload.php');
```
...
You can find more examples in the `examples` directory on the features required by the [Onboarding documentation](https://github.com/bitpesa/api-documentation/blob/master/quick-integration.md)
